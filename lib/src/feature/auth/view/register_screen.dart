  ...
  Widget build(BuildContext context) {
    return Observer(builder: (context) {
      if (registerState.state == RegisterStateAction.sendCode) {
        ...
        Future.microtask(
            () => context.pushNamed(AppViews.registerVerify, extra: phone));
      }
      return Container(
          ...
          child: Column(
            children: [
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: registerState.state ==
                                  RegisterStateAction.errorPhone
                ...
                children: [
                  ...
                  Expanded(
                    child: RichText(
                      ...
                      TextSpan(
                          text: "${t.register.agreement} ",
                          style: const TextStyle(
                              fontSize: 17,
                              fontWeight: FontWeight.w400,
                              color: AppColors.greyBrighterColor)),
                      TextSpan(
                          text: t.register.withTermOfUse,
                          style: const TextStyle(
                              fontSize: 17,
                              fontWeight: FontWeight.w400,
              ...
              ElevatedButton(
                  ...
                  onPressed: (registerState.state ==
                              RegisterStateAction.enableConfirmButton) &&
                          checkValue
                      ? () {
                          registerState.confirmPhone(
